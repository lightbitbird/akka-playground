...
case class Owner(id: Long, login: String, url: Option[String]) extends BaseEntity[Long]
case class GitRepo(id: Long, name: String, owner: Owner, url: String, language: Option[String]) extends BaseEntity[Long]
